...
public:
    ...
    {
        ImageViewerCv->setWindowTitle(QApplication::translate("ImageViewerCv", "Form", 0));
        groupBox->setTitle(QApplication::translate("ImageViewerCv", "GroupBox", 0));
        imgDisplay->setText(QApplication::translate("ImageViewerCv", "TextLabel", 0));
    } // retranslateUi
